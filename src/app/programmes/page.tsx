...
const stages = [
  {
    ...
    years: "Ages 4 - 6",
    desc: "Ignite curiosity through play-based mastery. We focus on core literacy, numeracy, and social confidence, giving young learners a massive head start before primary school.",
    subjects: ["Phonics & Reading", "Number Magic", "Creative Arts", "Discovery World", "Social Skills"],
  ...
  },
  {
    ...
    years: "Ages 16 - Adult",
    desc: "Master the tools that drive the modern economy. Intense, project-based courses designed to build a professional portfolio and career-ready expertise.",
    subjects: ["Full-Stack Development", "Graphic Design", "Data Analytics", "Digital Marketing", "UI/UX Design"],
  ...
  },
  {
    ...
    years: "Custom Age",
    desc: "A completely tailored curriculum built from the ground up. Perfect for students with unique goals, professional athletes, or those needing specialized support.",
    subjects: ["Flexible Scheduling", "Custom Subject Mix", "Mentor Matching", "Personal Projects", "Exam Resits"],
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {stages.map((stage, i) => (
              <motion.div 
                key={i}
                whileHover={{ y: -5 }}
                className="p-8 border-2 border-slate-100 rounded-sm hover:border-primary/20 hover:shadow-xl transition-all flex flex-col h-full bg-white"
              >
                <div className="flex justify-between items-start mb-6">
                  <div className={`p-3 ${stage.color || 'bg-slate-50'} rounded-sm`}>
                    {stage.icon}
                  </div>
                ...
                <div className="space-y-3 mb-8">
                  <p className="text-xs font-bold uppercase tracking-widest text-slate-400">Featured Topics</p>
